...
/**
 * This object is available inside a {@link Runnable} and contains methods to report progress, logs, and request cancellation.
 */
public class ProgressInfo {
     ...
     */
    public synchronized ProgressInfo detachProgress() {
        ProgressInfo result = new ProgressInfo(this);
     ...
     */
    public synchronized ProgressInfo resolve(String logPrepend) {
        ProgressInfo result = new ProgressInfo(this);
     ...
     * @return progress info with the same properties as the current one, but with messages prepended
     */
    public synchronized ProgressInfo resolve(String text, int index, int size) {
     ...
     * @return progress info with the same properties as the current one, but with messages prepended
     */
    public synchronized ProgressInfo resolveAndLog(String logPrepend) {
        ProgressInfo resolve = resolve(logPrepend);
        resolve.log("");
        return resolve;
    }
     ...
     * @return progress info with the same properties as the current one, but with messages prepended
     */
    public synchronized ProgressInfo resolveAndLog(String text, int index, int size) {
     ...
     */
    public <T> void resolveAndLogForEach(String text, Collection<T> collection, BiConsumer<T, ProgressInfo> function) {
        ...
        for (T item : collection) {
            ...
            ProgressInfo itemProgress = resolveAndLog(text + " " + (current + 1) + "/" + size);
     ...
     * @param <T>        collection contents
     */
    public <T> void resolveAndLogForEach(String text, T[] collection, BiConsumer<T, ProgressInfo> function) {
     ...
     * @param function   the function executed for each item in the collection
     */
    public void resolveAndLogForEach(String text, int[] collection, BiConsumer<Integer, ProgressInfo> function) {
        int size = collection.length;
        int current = 0;
     ...
     * @param function   the function executed for each item in the collection
     */
    public void resolveAndLogForEach(String text, byte[] collection, BiConsumer<Byte, ProgressInfo> function) {
        int size = collection.length;
        int current = 0;
     ...
     * @param function   the function executed for each item in the collection
     */
    public void resolveAndLogForEach(String text, long[] collection, BiConsumer<Long, ProgressInfo> function) {
        int size = collection.length;
        int current = 0;
     ...
     * @param function   the function executed for each item in the collection
     */
    public void resolveAndLogForEach(String text, short[] collection, BiConsumer<Short, ProgressInfo> function) {
        int size = collection.length;
        int current = 0;
     ...
     * @param function   the function executed for each item in the collection
     */
    public void resolveAndLogForEach(String text, float[] collection, BiConsumer<Float, ProgressInfo> function) {
        int size = collection.length;
        int current = 0;
     ...
     * @param function   the function executed for each item in the collection
     */
    public void resolveAndLogForEach(String text, double[] collection, BiConsumer<Double, ProgressInfo> function) {
        int size = collection.length;
        int current = 0;
    ...
    public static class StatusUpdatedEvent {
        private final ProgressInfo source;
        private final int progress;
        private final int maxProgress;
        private final String message;

        public StatusUpdatedEvent(ProgressInfo source, int progress, int maxProgress, String message) {
            this.source = source;
